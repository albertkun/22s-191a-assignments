...
function addMarker(data){
    ...
    L.marker([data.lat,data.lng]).addTo(map).bindPopup(`<h2>${data['Where is your hometown?? (City, State format please!)']}</h2> <h3>${data['how much do you spend a month on clothes/jewelry?']}</h3>`)
